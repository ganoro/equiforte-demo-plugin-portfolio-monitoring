...
- `/shared/plugins/accounting-c1a0cf4f/skills/design-system/references/components.md` — title page, table, chart patterns
...
```bash
cp /shared/plugins/accounting-c1a0cf4f/brand/assets/logo.png ./logo.png 2>/dev/null || true
```
