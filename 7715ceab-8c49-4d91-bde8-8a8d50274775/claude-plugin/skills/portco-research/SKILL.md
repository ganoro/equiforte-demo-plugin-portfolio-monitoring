...
1. Read `/shared/plugins/support-7715ceab/skills/design-system/references/tokens.md` for colors, fonts, number formatting
2. Read `/shared/plugins/support-7715ceab/skills/design-system/references/components.md` for component patterns
3. Read `/shared/plugins/support-7715ceab/brand/assets/brand-overrides.json` for firm name and confidentiality notice
4. Copy logo: `cp /shared/plugins/support-7715ceab/brand/assets/logo.png ./logo.png 2>/dev/null || true`

Then read the appropriate generator skill:
- **Excel (.xlsx)** → read `/shared/plugins/support-7715ceab/skills/output-generation/xlsx-generator/SKILL.md`
- **PowerPoint (.pptx)** → read `/shared/plugins/support-7715ceab/skills/output-generation/pptx-generator/SKILL.md`
- **PDF** → read `/shared/plugins/support-7715ceab/skills/output-generation/docx-generator/SKILL.md` (use reportlab or fpdf2 for PDF)
