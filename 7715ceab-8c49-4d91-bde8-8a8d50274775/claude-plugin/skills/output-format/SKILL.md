...
- `/shared/plugins/support-7715ceab/skills/design-system/references/tokens.md` — colors, typography, number formatting
- `/shared/plugins/support-7715ceab/skills/design-system/references/components.md` — title page, table, chart patterns
...
```bash
cp /shared/plugins/support-7715ceab/brand/assets/logo.png ./logo.png 2>/dev/null || true
```
