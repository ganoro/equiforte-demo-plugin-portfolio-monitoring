...
- `/shared/plugins/sales-346daa1b/skills/design-system/references/tokens.md` — colors, typography, number formatting
- `/shared/plugins/sales-346daa1b/skills/design-system/references/components.md` — title page, table, chart patterns
...
```bash
cp /shared/plugins/sales-346daa1b/brand/assets/logo.png ./logo.png 2>/dev/null || true
```
